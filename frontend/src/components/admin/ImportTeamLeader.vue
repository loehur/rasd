        ...
        <div class="max-w-4xl mx-auto">
            ...
            <div class="mb-8">
                ...
                <p class="text-slate-400 mt-2">
                    Upload CSV file to import team leaders with default
                    password:
            ...
            >
                ...
                <div class="mt-4 flex items-center justify-between">
                    ...
                    <a
                        :href="`${API_BASE_URL}/api/team-leaders/template`"
                        download
            ...
            <div v-if="selectedFile" class="flex gap-4">
                ...
                >
                    ...
                    ></span>
                    <span>{{
                        uploading ? "Importing..." : "Import Team Leader Data"
                    }}</span>
                </button>
            </div>
...
const importData = async () => {
    ...
    try {
        ...
        const response = await fetch(
            `${API_BASE_URL}/api/team-leaders/import`,
            {
                method: "POST",
                headers: {
