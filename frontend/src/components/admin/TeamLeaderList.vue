        ...
        <div class="max-w-7xl mx-auto">
            ...
            >
                <div class="flex gap-2">
                    ...
                    <button
                        @click="goToImport"
                        class="px-4 py-2 text-sm bg-blue-600/20 text-blue-400 border border-blue-600/30 rounded-lg hover:bg-blue-600/30 transition flex items-center gap-2"
                        title="Import team leader"
                    >
                        <svg
                            class="w-5 h-5"
                            fill="none"
